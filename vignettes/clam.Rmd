...
coredir <- tempfile() 
dir.create(coredir) # making sure the folder exists
clam(coredir=coredir, ask=FALSE)
```
...
clam(coredir=coredir, ask=FALSE, type=4, outliers=6, hiatus=470, dmax=800, slump=c(220, 250))
```

...
coredir <- file.path(base_temp_dir, "clam_runs")
dir.create(coredir, recursive = TRUE, showWarnings = FALSE)
coredir <- clam:::assign_coredir(coredir, core="Example", ask=FALSE)
#clam(, ask=FALSE, coredir=coredir)
...
if(core == "Example") {
  ...
  ccdir <- ""
  ccdir <- clam:::.validateDirectoryName(ccdir)
